...
public static class DBInitializer
{
    public static void Initialize()
    {
        using (LibraryContext context = new LibraryContext())
        {
            ...
            {
                new User { UserId = 1, Login = "John Doe", Password = "pass", Gender = Gender.Male, AccessRights = AccessRights.Owner },
                new User { UserId = 2, Login = "Jane Smith", Password = "pass", Gender = Gender.Female, AccessRights = AccessRights.Administrator }
            };
            ...
            {
                new Book { BookId = 1, ProductId = 1, Author = "F. Scott Fitzgerald", Genre = "Fiction", PublicationYear = 1925 }
            };
            ...
            {
                new Game { GameId = 1, DiscId = 3, Platform = 1, Developer = "Activision" }
            };
